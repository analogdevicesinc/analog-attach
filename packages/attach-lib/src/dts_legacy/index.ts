...
export { print_dts as printDts, print_value } from "./printer.js";
export { merge_document as mergeDocument, merge_node as mergeNode } from "./merge.js";
export { markNodesModified, search_node_in_dts, search_node_in_unresolved_overlays, get_node_key } from "./utilities.js";
